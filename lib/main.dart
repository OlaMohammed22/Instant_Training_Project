...
import 'package:untitled36/Data/add_record_repo.dart';
import 'package:untitled36/bloc/bloc.dart';
import 'package:untitled36/repository/repository.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        RepositoryProvider(
          create: (context)=>CaseDetailsRepository(),
        ),
          BlocProvider(
          create: (context) => AddRecordBloc(ApiServicesss(),context),
           child: case_index_one(), // Pass it here
        ),   
