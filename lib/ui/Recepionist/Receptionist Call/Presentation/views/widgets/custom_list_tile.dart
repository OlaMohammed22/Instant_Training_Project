...
class CustomListTile extends StatelessWidget {
  const CustomListTile({
    ...
    required this.text,
    this.onTap,
    required this.selectDoctorFormKey,
  });
  final String text;
  final void Function()? onTap;
  final GlobalKey<FormFieldState> selectDoctorFormKey;
  @override
  Widget build(BuildContext context) {
    return BlocConsumer<SelectDoctorCubit, SelectDoctorState>(
      ...
      builder: (context, state) {
        return FormField<String>(
          ...
          key: selectDoctorFormKey,
          validator: (value) {
            if (SelectDoctorCubit.doctorInfoModel != null) {
              return null;
            }
