...
Widget build(BuildContext context) {
  return Scaffold(
    ...
    backgroundColor: Colors.white,
    body: BlocProvider(
      create: (context) => CaseBlocc(CaseRepository())..add(FetchCasesEvent()), 
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.calendar_today, caseData.created_at?.toString() ?? 'No Status'),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Case_details(caseData.id)),
                  );
                },
