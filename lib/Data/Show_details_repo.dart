...
import 'package:untitled36/Data/Show_details_model.dart';


class CaseDetailsRepository {
  ...
  Future<Show_details> getCases(int id) async {
    print("Fetching cases...");
    Response response = await get(Uri.parse('https://hospital.elhossiny.net/api/v1/case/$id'), headers: {
    ...
    if (jsonDecode(response.body)['status'] == 1) {
      ...
      print(result);
      print(Show_details.fromJson(result));
      print("3");
      return Show_details.fromJson(result);
    } else {
