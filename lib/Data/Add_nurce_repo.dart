...
class ApiService {
  ...
  Future<void> addNurse(BuildContext context, Map<String, dynamic> nurseData) async {
    ...
    if (response.statusCode == 201 || response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Failed to add nurse: ${response.statusCode}"), backgroundColor: Colors.red),
      );
    }
  }
}
