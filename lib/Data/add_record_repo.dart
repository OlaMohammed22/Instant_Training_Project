...
class ApiServicesss {
  ...
  Future<void> addrecord(BuildContext context, Map<String, dynamic> addrecordData) async {
    ...
    if (response.statusCode == 201 || response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Failed to add record: ${response.statusCode}"), backgroundColor: Colors.red),
      );
    }
  }
}
